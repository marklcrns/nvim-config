...
let g:which_key_map = {
    ...
    \ 'b' : {
          \ 'name' : '+buffer',
          \ 'a' : 'Alternate with last buffer',
          \ 'A' : 'Bang alternate with last buffer',
          \ 'b' : 'Unload current buffer',
          \ 'B' : 'Bang unload current buffer',
          \ 'd' : 'Delete current buffer',
          \ 'D' : 'Bang Delete current buffer',
          \ 'n' : 'Buffer forward from BufKill list',
          \ 'N' : 'Bang buffer forward from BufKill list',
          \ 'p' : 'Buffer backward from BufKill list',
          \ 'P' : 'Bang Buffer backward from BufKill list',
          \ 'u' : 'Undo buffer kill (includes wiped)',
          \ 'w' : 'Wipe current buffer',
          \ 'W' : 'Bang Wipe current buffer',
          \ },
    \ 'c' : {
          \ 'name' : '+coc',
